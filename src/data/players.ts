...
export const mockPlayers: Player[] = [
  { id: "demo-1", firstName: "Darius", lastName: "Hoalba", number: 1, position: "Portar", photo: "/darius.jpg", biography: "Blocheaza suturile cu fata si are mai multe goluri ca multi din echipa:))" },
  ...
  { id: "demo-5", firstName: "Alexandru", lastName: "Miclaus", number: 10, position: "Atacant", photo: "/miclaus.jpg", biography: "Imaginație cu mingea la picior și curaj în momentele decisive." },
  ...
  { id: "demo-7", firstName: "Alexandru", lastName: "Petras", number: 9, position: "Atacant", photo: "/petras.jpg", biography: "Foloseste puterea prieteniei sa incurjeze coechipierii. Numar record de bari din vole." },
